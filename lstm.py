    ...
    def forward(self, x: Tensor, h_0: Tensor = None, c_0: Tensor = None):
        ...
        for layer in range(self.num_layers):
            ...
            for t in range(seq_len):
                ...
                h_t_minus_1_forward, c_t_minus_1_forward = self.lstm_cell(input, h_t_minus_1_forward, c_t_minus_1_forward, weights_forward)
...
if __name__ == "__main__":
    ...
    pytorch_lstm = nn.LSTM(input_size, 
                    hidden_size, 
                    num_layers, 
                    bias=bias,
                    batch_first=True, 
    ...
    lstm_from_scratch = LSTM(input_size, 
                hidden_size, 
                num_layers, 
                bias=bias,
                batch_first=True, 
    ...
    copy_parameters(lstm_from_scratch, pytorch_lstm, num_layers, bias, bidirectional)

    # Test the output again
    out, _ = lstm_from_scratch(input)
    pytorch_out, _ = pytorch_lstm(input)
